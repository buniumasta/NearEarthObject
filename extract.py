    ...
    with open(neo_csv_path) as csv_file:
        ...
        for line in reader:
            if nm_lines == 0:
                ...
                loaded_neos.append(NearEarthObject(line[pdes_i],line[name_i],line[diameter_i],line[pha_i]))
            nm_lines += 1
            #if nm_lines > 1005:
            #    break
    return loaded_neos
...
def load_approaches(cad_json_path="./data/cad.json"):
    ...
    try:
        ...
        for record in list_approaches:
            ...
            loaded_approaches.append(CloseApproach(record[des_index],record[cd_index],record[dist_index],record[v_rel_index]))
