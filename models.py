...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        if self.hazardous:
            ...
            condition='is not'
        return f"A NearEarthObject {fullname} has a diameter of {diameter:.3f} km and {condition} potentially hazardous."
...
class CloseApproach:
    ...
    def __init__(self, **info):
        ...
        self._designation = ''
        self._time = None  # TODO: Use the cd_to_datetime function for this attribute.
        self._distance = 0.0
        self._velocity = 0.0
